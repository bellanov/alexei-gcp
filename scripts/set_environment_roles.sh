...
EXISTING_ROLES="roles/cloudbuild.builds.editor roles/secretmanager.admin roles/storage.admin"
...
ASSIGN_ROLES="roles/cloudbuild.builds.editor roles/secretmanager.admin roles/storage.admin"
