...
EXISTING_ROLES="roles/artifactregistry.admin roles/cloudbuild.builds.editor roles/run.admin roles/storage.admin roles/secretmanager.admin roles/iam.serviceAccountAdmin"
...
ASSIGN_ROLES="roles/artifactregistry.admin roles/cloudbuild.builds.editor roles/run.admin roles/storage.admin roles/secretmanager.admin roles/iam.serviceAccountAdmin"
